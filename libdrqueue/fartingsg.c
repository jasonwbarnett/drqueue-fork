...
char *fartingsg_create (struct fartingsgi *info) {
  /* This function creates the farting render script based on the information given */
  ...
  if(ji) {
    ...
    jobscript_template_write (ji,"farting_sg.py");
    jobscript_close (ji);
  } else {
    drerrno = DRE_NOTCOMPLETE;
    return NULL;
...
char *fartingsg_default_script_path (void) {
